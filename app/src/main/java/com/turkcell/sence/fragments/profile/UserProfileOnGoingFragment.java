 ...
 */
public class UserProfileOnGoingFragment extends Fragment {
    ...
    public UserProfileOnGoingFragment(Activity activity, User user) {
        this.activity = activity;
        this.user = user;
    }

    public UserProfileOnGoingFragment(Activity activity, User user, boolean isFollowing) {
        this.activity = activity;
        this.user = user;
