...
public class UserProfileFollowersFragment extends Fragment {
    ...
    public UserProfileFollowersFragment(FragmentManager supportFragmentManager, Activity activity, User user) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_user_profile_followers, container, false);
        progressFrame = view.findViewById(R.id.userprofilefollowersFrame_Fl);
        recyclerView = view.findViewById(R.id.userprofilefollowersUsers_Lv);
        warningTv = view.findViewById(R.id.userprofilefollowersWarning_Tv);
        warningTv.setText("Hiç ünlü değilsin takipçin yok.");
