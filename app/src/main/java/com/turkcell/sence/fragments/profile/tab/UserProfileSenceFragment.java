...
public class UserProfileSenceFragment extends Fragment {
    ...
    public UserProfileSenceFragment(Activity activity, User user) {
        this.activity = activity;
        this.user = user;
    }

    public UserProfileSenceFragment(Activity activity, User user, boolean isFollowing) {
        this.activity = activity;
        this.user = user;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_user_profile_sence, container, false);
        surveyListView = view.findViewById(R.id.userprofilesenceSurveys_Lv);
        warningTv = view.findViewById(R.id.userprofilesenceWarning_Tv);
        homeFrameFl = view.findViewById(R.id.userprofilesenceFrame_Fl);
